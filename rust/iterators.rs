...
// ║                                                                                                                                                ║
// ║                    1. ITERATOR NIMA?                                                                                                           ║
// ║                       • Iterator – bu Rust’dagi `std::iter::Iterator` trait’i bo‘lib, kolleksiyalar (Vec, HashMap, String, Array)              ║
// ║                         ichidagi elementlarni ketma‑ket qayta ishlash uchun mo‘ljallangan yagona standart interfeysdir.                        ║
// ║                       • Iterator **lazy** (dangasa) ishlaydi: `next()` chaqirilmaguncha yoki `collect()`, `sum()` kabi yakunlovchi             ║
// ║                         metod ishga tushmaguncha hech qanday hisob‑kitob amalga oshirilmaydi. Bu katta hajmdagi maʼlumotlar bilan              ║
// ║                         ishlaganda xotirani sezilarli tejaydi.                                                                                 ║
// ║                                                                                                                                                ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                    2. ASOSIY QONUN VA QOIDALAR (INTERVYUDA MUHIM)                                                                              ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                                                                                                                                                ║
// ║                   ┌───────────────────────────┬────────────────────────────────────────────────────────────────────────────────┐               ║
// ║                   │ Qoida                     │ Taʼrif va ahamiyati                                                            │               ║
// ║                   ├───────────────────────────┼────────────────────────────────────────────────────────────────────────────────┤               ║
// ║                   │ **Ownership (egalik)**    │ • `.iter()`      → `&T`  – qarz, kolleksiya saqlanib qoladi.                   │               ║
// ║                   │                           │ • `.iter_mut()`  → `&mut T` – o‘zgartirish mumkin.                             │               ║
// ║                   │                           │ • `.into_iter()` → `T`    – to‘liq egalik, kolleksiya yo‘q qilinadi.           │               ║
// ║                   ├───────────────────────────┼────────────────────────────────────────────────────────────────────────────────┤               ║
// ║                   │ **Zero‑Cost Abstraction** │ Iterator zanjirlari (`map`, `filter`, `fold`) kompilyatsiya vaqtida oddiy      │               ║
// ║                   │                           │ `for` sikllari bilan bir xil tezlikdagi mashina kodiga aylanadi. Qo‘shimcha    │               ║
// ║                   │                           │ ish vaqti xarajati yo‘q.                                                       │               ║
// ║                   ├───────────────────────────┼────────────────────────────────────────────────────────────────────────────────┤               ║
// ║                   │ **Adapter vs Consumer**   │ • **Adapterlar** (`map`, `filter`, `take`, `skip`) – yangi iterator qaytaradi, │               ║
// ║                   │                           │   hali hisob‑kitob qilmaydi (lazy).                                            │               ║
// ║                   │                           │ • **Consumerlar** (`collect`, `sum`, `fold`, `count`) – iteratorni ishga       │               ║
// ║                   │                           │   tushiradi va natijaviy qiymat qaytaradi.                                     │               ║
// ║                   └───────────────────────────┴────────────────────────────────────────────────────────────────────────────────┘               ║
// ║                                                                                                                                                ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                   3. ITERATOR QAYSI TURLAR BILAN ISHLAYDI?                                                                                     ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                                                                                                                                                ║
// ║                   ┌───────────────────────────────┬─────────────────────────────────────────────────────────────────────────────┐              ║
// ║                   │ Tur                           │ Qanday iterator manbai?                                                     │              ║
// ║                   ├───────────────────────────────┼─────────────────────────────────────────────────────────────────────────────┤              ║
// ║                   │ **Standart kolleksiyalar**    │ `Vec<T>`, `VecDeque<T>`, `LinkedList<T>`, `HashMap<K,V>`, `HashSet<T>`,     │              ║
// ║                   │                               │ `BTreeMap`, `BTreeSet`                                                      │              ║
// ║                   ├───────────────────────────────┼─────────────────────────────────────────────────────────────────────────────┤              ║
// ║                   │ **Matn turlari**              │ `String` / `&str` → `.chars()`, `.lines()`, `.split_whitespace()`,          │              ║
// ║                   │                               │ `.split(pattern)`                                                           │              ║
// ║                   ├───────────────────────────────┼─────────────────────────────────────────────────────────────────────────────┤              ║
// ║                   │ **Range (oraliq)**            │ `0..10` (yarim ochiq), `0..=10` (yopiq), `(0..).take(10)` – cheksiz         │              ║
// ║                   ├───────────────────────────────┼─────────────────────────────────────────────────────────────────────────────┤              ║
// ║                   │ **Option / Result**           │ `Option<T>` – 0 yoki 1 element; `Result<T,E>` – muvaffaqiyat yoki xatolik.  │              ║
// ║                   │                               │ Ularning o‘zi ham iterator (`into_iter()`, `iter()`).                       │              ║
// ║                   ├───────────────────────────────┼─────────────────────────────────────────────────────────────────────────────┤              ║
// ║                   │ **Fayllar**                   │ `BufReader::lines()` – satrma‑satr o‘qiydi, xotirani tejaydi.               │              ║
// ║                   └───────────────────────────────┴─────────────────────────────────────────────────────────────────────────────┘              ║
// ║                                                                                                                                                ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                   4. ASOSIY ITERATOR METODLARI (INTERVYUDAGI SAVOLLAR UCHUN JADVAL)                                                            ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                                                                                                                                                ║
// ║                   ┌─────────────────────┬──────────────────┬─────────────────────────────────────────────────────────────────────┐             ║
// ║                   │ Kategoriya          │ Metod            │ Vazifasi (nima qiladi?)                                             │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Asosiy              │ `next()`         │ Keyingi elementni `Option<Item>` sifatida qaytaradi.                │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Yaratish            │ `iter()`         │ `&T` qaytaruvchi iterator yaratadi (qarz).                          │             ║
// ║                   │                     │ `iter_mut()`     │ `&mut T` qaytaruvchi iterator yaratadi.                             │             ║
// ║                   │                     │ `into_iter()`    │ `T` qaytaruvchi iterator yaratadi (egalik).                         │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ O‘zgartirish        │ `map(closure)`   │ Har bir elementni closure orqali yangi qiymatga aylantiradi.        │             ║
// ║                   │                     │ `filter(closure)`│ Shartni qanoatlantirmaydigan elementlarni olib tashlaydi.           │             ║
// ║                   │                     │ `filter_map()`   │ Bir vaqtning o‘zida `filter` va `map` bajaradi (Option bilan).      │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Yassilash           │ `flatten()`      │ Ichma‑ich iteratorlarni bir darajaga tushiradi.                     │             ║
// ║                   │                     │ `flat_map()`     │ `map()` + `flatten()` birgalikda.                                   │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Qidiruv / Tekshirish│ `find(predikat)` │ Shartni qanoatlantiruvchi birinchi elementni `Option<&T>` da beradi.│             ║
// ║                   │                     │ `position(pred)` │ Shartni qanoatlantiruvchi birinchi element indeksini beradi.        │             ║
// ║                   │                     │ `any(predikat)`  │ Kamida bitta element shartga javob bersa `true`.                    │             ║
// ║                   │                     │ `all(predikat)`  │ Barcha elementlar shartga javob bersa `true`.                       │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Miqdor cheklash     │ `take(n)`        │ Birinchi `n` ta elementni oladi, qolganini tashlaydi.               │             ║
// ║                   │                     │ `skip(n)`        │ Birinchi `n` ta elementni o‘tkazib yuboradi.                        │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Kombinatsiya        │ `zip(boshqa)`    │ Ikki iteratorni parallel bog‘lab, juftliklar qaytaradi.             │             ║
// ║                   │                     │ `chain(boshqa)`  │ Bir iterator oxiriga ikkinchisini ulaydi.                           │             ║
// ║                   │                     │ `enumerate()`    │ Elementga `(indeks, &qiymat)` qo‘shib beradi.                       │             ║
// ║                   ├─────────────────────┼──────────────────┼─────────────────────────────────────────────────────────────────────┤             ║
// ║                   │ Yig‘ish (Consumer)  │ `collect()`      │ Iteratorni `Vec`, `HashMap`, `String` yoki boshqa kolleksiyaga      │             ║
// ║                   │                     │                  │ yig‘adi (eng ko‘p ishlatiladigan consumer).                         │             ║
// ║                   │                     │ `fold(boshl, f)` │ Akkumulyator yordamida barcha elementlarni bitta qiymatga jamlaydi. │             ║
// ║                   │                     │ `sum()`          │ Sonli elementlar yig‘indisini hisoblaydi.                           │             ║
// ║                   │                     │ `product()`      │ Sonli elementlar ko‘paytmasini hisoblaydi.                          │             ║
// ║                   │                     │ `count()`        │ Iterator elementlari sonini qaytaradi.                              │             ║
// ║                   └─────────────────────┴──────────────────┴─────────────────────────────────────────────────────────────────────┘             ║
// ║                                                                                                                                                ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                 5. INTERVYUDA TEZ‑TEZ SO‘RALADIGAN SAVOLLAR VA JAVOBLAR                                                                        ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                                                                                                                                                ║
// ║                 ┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐             ║
// ║                 │   Savol 1: Iterator bilan oddiy `for` siklining farqi nimada?                                                  │             ║
// ║                 │   Javob:   `for` sikli iterator mexanizmi ustiga qurilgan sintaktik shakardir. Kompilyator `for x in y` ni     │             ║
// ║                 │            avtomatik tarzda `let mut iter = y.into_iter(); while let Some(x) = iter.next() { ... }` ga         │             ║
// ║                 │            aylantiradi. Iteratorlar esa zanjirli chaqiruv (`.map().filter().collect()`) imkonini berib,        │             ║
// ║                 │            funksional dasturlash uslubini qo‘llab‑quvvatlaydi va kodni ixcham, xatosiz qiladi.                 │             ║
// ║                 ├────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤             ║
// ║                 │   Savol 2: `.iter()` va `.into_iter()` farqi qanday?                                                           │             ║
// ║                 │   Javob:   `.iter()` kolleksiyani qarzga oladi (`&T`) – siz kolleksiyani keyin ham ishlata olasiz.             │             ║
// ║                 │            `.into_iter()` esa kolleksiyani to‘liq egallab oladi (`T`) – iterator tugagach, asl kolleksiya      │             ║
// ║                 │            mavjud bo‘lmaydi. Elementlarni faqat o‘qish kerak bo‘lsa `.iter()`, ularni boshqa joyga ko‘chirish  │             ║
// ║                 │            yoki egallash kerak bo‘lsa `.into_iter()` ishlatiladi.                                              │             ║
// ║                 ├────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤             ║
// ║                 │   Savol 3: Rust iteratori xavfsizmi? Nima uchun C++ dagi iteratordan afzal?                                    │             ║
// ║                 │   Javob:   Rust iteratori xavfsiz, chunki Borrow Checker qoidalari tufayli “iterator invalidation”             │             ║
// ║                 │            (iteratorning yaroqsiz bo‘lib qolishi) muammosiga yo‘l qo‘yilmaydi. Kolleksiyani o‘zgartirishga     │             ║
// ║                 │            urinsangiz, iterator hali yashab turgan bo‘lsa, kompilyator xato beradi. Bu dangling pointer va     │             ║
// ║                 │            segmentatsiya xatolarini kompilyatsiya vaqtida oldini oladi. C++ da esa bu ish vaqtida xatolik      │             ║
// ║                 │            keltirib chiqarishi mumkin.                                                                         │             ║
// ║                 ├────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤             ║
// ║                 │   Savol 4: Iterator zanjiri juda uzun bo‘lsa, ishlash tezligi pasayadimi?                                      │             ║
// ║                 │   Javob:   Yo‘q, pasaymaydi. Rust iterator adapterlari **Zero‑Cost Abstraction** tamoyiliga asoslanadi.        │             ║
// ║                 │            `.iter().map().filter().sum()` kabi zanjir kompilyatsiya vaqtida qo‘lda yozilgan yagona `for` sikli │             ║
// ║                 │            bilan bir xil tezlikda ishlaydigan mashina kodiga aylantiriladi. Oraliq kolleksiyalar yaratilmaydi. │             ║
// ║                 ├────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤             ║
// ║                 │   Savol 5: `collect()` metodi qanday ishlaydi va u qanday turlarni qabul qiladi?                               │             ║
// ║                 │   Javob:   `collect()` – bu eng qudratli consumer. U `FromIterator` trait’ini implement qilgan istalgan        │             ║
// ║                 │            turga iteratorni yig‘a oladi: `Vec<T>`, `HashMap<K,V>`, `HashSet<T>`, `String`,                     │             ║
// ║                 │            `Result<Vec<T>,E>` va hokazo. Ko‘pincha turbofish sintaksisi ishlatiladi: `.collect::<Vec<_>>()`.   │             ║
// ║                 └────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘             ║
// ║                                                                                                                                                ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                6. ITERATORLARDAN QAYSI HOLATLARDA FOYDALANISH MAJBURIY YOKI FOYDALI?                                                           ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                                                                                                                                                ║
// ║                ┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐              ║
// ║                │   Maʼlumotlarni filtrlash va o‘zgartirish – `if‑else` bloklari o‘rniga ixcham zanjir.                          │              ║
// ║                │   Xatolarni boshqarish – `Result<Vec<T>, E>` shaklida yig‘ib, birinchi xatoda to‘xtash yoki barchasini yig‘ish.│              ║
// ║                │   Cheksiz ketma‑ketliklar – `(0..).map(...).take(10)` – faqat kerakli qism hisoblanadi, xotira tejaladi.       │              ║
// ║                │   Katta fayllar – `BufReader::lines()` orqali butun faylni RAMga yuklamasdan, satrma‑satr ishlash.             │              ║
// ║                │   O‘qilishi qiyin bo‘lgan ichma‑ich sikllarni soddalashtirish – `flat_map`, `flatten` yordamida.               │              ║
// ║                └────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘              ║
// ║                                                                                                                                                ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                7. XULOSA – BILISH KERAK BO‘LGAN ENG MUHIM NUQTALAR                                                                             ║
// ╠════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║                                                                                                                                                ║
// ║                ┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐              ║
// ║                │ 🔹 Trait: `std::iter::Iterator`                                                                                │              ║
// ║                │ 🔹 Asosiy metod: `fn next(&mut self) -> Option<Self::Item>`                                                    │              ║
// ║                │ 🔹 Lazylik: Hisoblash faqat consumer chaqirilganda boshlanadi.                                                 │              ║
// ║                │ 🔹 Adapterlar: Iterator qaytaradi, lazy.                                                                       │              ║
// ║                │ 🔹 Consumerlar: Yakuniy qiymat qaytaradi, iteratorni “isteʼmol” qiladi.                                        │              ║
// ║                │ 🔹 `DoubleEndedIterator`: `next_back()` metodi bilan orqadan ham o‘qish imkonini beradi (`rev()` uchun).       │              ║
// ║                │ 🔹 `ExactSizeIterator`: Iteratorning aniq uzunligi borligini bildiradi (`len()` metodi ishlaydi).              │              ║
// ║                │ 🔹 Zero‑Cost Abstraction: Iterator zanjirlaridan qo‘rqmasdan foydalaning – tezlik yo‘qotilmagan holda xavfsiz. │              ║
// ║                └────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘              ║
// ║                                                                                                                                                ║
// ╚════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
